//เขียน form,name,email,password,confrim
//ดักจับ evet 'submit' ใน form
//เขียน function checkPassword() เช็ค password เท่ากับ confirm หรือไม่
//ถ้าไม่ให้แสดงรหัสผ่านไม่ตรงกัน
